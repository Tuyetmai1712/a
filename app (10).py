...
animal_list = [
    ...
    ("🦅","Bạn quan sát tinh tế như đại bàng trong Class Days, không bỏ lỡ kiến thức."),
    ("🐜","Bạn chăm chỉ như kiến khi làm questionnaires, kiên trì từng bước."),
    ("🦩","Bạn quý phái như hồng hạc trong PCC, duyên dáng hỗ trợ đồng đội."),
    ("🦄","Bạn thăng hoa như kỳ lân khi thực hành lãnh đạo, tỏa sáng dẫn đầu."),
